...
#ifndef PET_SITTER_APP_SWIFT_H
#define PET_SITTER_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pet_sitter_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14pet_sitter_app11AppDelegate")
...
SWIFT_CLASS("_TtC14pet_sitter_app17MainFlutterWindow")
